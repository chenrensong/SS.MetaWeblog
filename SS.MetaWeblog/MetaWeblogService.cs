...
namespace SS.MetaWeblog
{
    public class MetaWeblogService : XmlRpcService
    {
        ...
        public async Task<IList<BlogInfo>> GetUsersBlogs(string key, string username, string password)
        {
        ...
        public async Task<IList<Post>> GetRecentPosts(string blogid, string username, string password, int numberOfPosts)
        {
